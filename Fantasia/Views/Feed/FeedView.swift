...
struct FeedView: View {
    ...
    var body: some View {
        ZStack {
            ...
            // minimumDistance MUST stay >= 20: a 0-distance DragGesture on a ScrollView engages
            // on touch-down and wins gesture arbitration on a quick flick from rest, blocking the
            // scroll (see LibraryView + GenerationManager.isInteracting doc comment).
            .simultaneousGesture(
